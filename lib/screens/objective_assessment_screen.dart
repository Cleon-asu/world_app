          ...
          body: ListView(
            ...
            children: [
              ...
              _buildResultCard(
                ...
                score: provider.getLatestScore(CognitiveDomain.fluenciaAlternant),
                description: 'Word generation speed and flexibility.',
                icon: Icons.chat_bubble_outline,
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const FluencyAssessmentScreen()),
                  );
                },
              ),
              _buildResultCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const AttentionAssessmentScreen()),
                  );
                },
              ),
              _buildResultCard(
                ...
                score: provider.getLatestScore(CognitiveDomain.memoriaTreball),
                description: 'Short-term information retention.',
                icon: Icons.memory_outlined,
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const WorkingMemoryAssessmentScreen()),
                  );
                },
              ),
              _buildResultCard(
                ...
                score: provider.getLatestScore(CognitiveDomain.velocitatProcessament),
                description: 'Speed of cognitive task completion.',
                icon: Icons.speed_outlined,
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const ProcessingSpeedScreen()),
                  );
                },
              ),
            ],
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildMetricColumn('--', 'Accuracy'), // Placeholder for aggregation logic
