...
class LearningPathScreen extends StatelessWidget {
  ...
  static const _psychoeducationPath = TreatmentPath(
    ...
    description:
        "Fundamental knowledge about cognition and cognitive functions",
  ...
  static const _lifestylePath = TreatmentPath(
    ...
    description:
        "Congratulations! No cognitive issues detected. Maintain healthy habits:",
    category: "Lifestyle",
    videos: [
      TreatmentVideo(
        id: "life_001",
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(
                  _getIconForCategory(path.category),
                  color: _getColorForCategory(path.category),
                  size: 32,
                ),
